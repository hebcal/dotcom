...
<!-- $Id: index.php,v 1.166 2006/10/17 20:16:25 mradwin Exp mradwin $ -->
<html lang="en">
<head>
...
<link rel="stylesheet" type="text/css" href="/i/yui-0.11.4/fonts-min.css"> 
<link rel="stylesheet" type="text/css" href="/i/yui-0.11.4/grids-min.css"> 
<link rel="stylesheet" href="/style.css" type="text/css">
<base href="http://www.hebcal.com/" target="_top">
</head>
<body>
<div id="doc" class="yui-t4" style="width:100%">
<div id="hd">
...
<div class="yui-b">
<div style="background:#fda;padding:0.5em">
<h3>Quick Links</h3>
<hr noshade size="1">
<ul class="gtl">
<!-- Begin temp holiday -->
