...
if (isset($_SERVER["QUERY_STRING"]) &&
    strlen($_SERVER["QUERY_STRING"]) == 24) {
    $info = get_sub_info($_SERVER["QUERY_STRING"]);
} else {
    header("HTTP/1.0 400 Bad Request");
    echo "Missing QUERY_STRING";
    exit(0);
}
...
<base href="http://www.hebcal.com/email/verify" target="_top">
...
3.5 for UNIX</a>, Copyright &copy; 2006 Danny Sadinoff. All rights reserved.
...
<form name="f1" id="f1" action="/email/tmp.php" method="post">
...
http://www.hebcal.com/email/verify?$encoded
